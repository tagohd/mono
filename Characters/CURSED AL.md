...
sudo:: Eh, I'm not sure they really have a copyright on that and/or the SRD is under an open license. And I don't know. I think we have at least 3 so far. We've got the Material Plane, the Mana Plane, Eeby Deeby, wherever THE NEEDLE is, and wherever the THE BEE is, but some of those could be the same plane.
#reply [R:: 3]
