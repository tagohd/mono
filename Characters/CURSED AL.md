...
>2. Because [[Teleport]] doesn't work the same way in MONO as it does in D&D, [[Plane Shift]] only permits travel along the Z axis. Your X and Y coordinates don't change. (Summoning [[MELADRIËN|The Emperoress]], as in [[2. Plot Overview (Again)]], is an exception.
