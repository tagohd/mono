...
1. AL already has the other Artifacts. This makes sense if he invented them, and it adds a lot of weight to the scripted game over idea, especially if that's how AL acquires the ones he's missing. (Maybe Luke feels like it's his fault for not being strong enough.)
2. James *does* know about the other Artifacts somehow/Luke finds out some other way
3. As an employee of IMAS, Case has heard rumors about the existence of the other Artifacts. He's an apprentice, and he's only been there about a month, so he's probably not privy to any particularly good intel. But maybe this leads to a section where you have 
