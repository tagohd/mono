...
SOUL fusion essentially combines two or more SOULS into one unit. The mechanism behind it is unclear, but light focused through THE CRYSTAL seems to trigger the reaction. With inanimate objects, the resultant ÜBERSOUL decays rapidly on exposure to [[Mana]] concentrations above 500 GEj, though casting spells that call for higher concentrations of Mana may still be possible. For ÜBERSOULS formed in living vessels, the bonds are predicted to remain stable at concentrations in excess of 1.21 PEj.
