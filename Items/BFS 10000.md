...
| $n$  | $M_I$      |$M_C$  |
|----|----------|-----|
| 2  | $4.07 \times 10^{15}$ Ej |
| 3  | $7.50 \times 10^{17}$ Ej |
| 4  | $9.70 \times 10^{19}$ Ej |
| 5  | $1.03 \times 10^{22}$ Ej |
| 6  | $9.76 \times 10^{23}$ Ej |
| 7  | $8.46 \times 10^{25}$ Ej |
| 8  | $6.90\times10^{27}$ Ej |
| 9  | $5.36 \times 10^{29}$ Ej |
| 10 | $4.02\times10^{31}$ Ej |
| 11 | $2.92\times10^{33}$ Ej |
| 12 | $2.07\times10^{35}$ Ej |
| 13 | $1.44\times 10^{37}$ Ej |
