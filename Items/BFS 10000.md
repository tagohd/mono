...
Priority:: 1
sudoMajor:: Lots of details about how it works. Too many details perhaps. But, hey! Worldbuilding! Also moved old discussion to [[(Talk) BFS 10000]].
...
2. Touch THE BLADE to a vessel, e.g. [[CURSED AL'S CURSED ORB|THE ORB]]. The SOUL is not guaranteed to remain stable when transferred this way.
	1. Maybe you have to use some sort of spell for this, or it has to be a specialized vessel. Otherwise, any inanimate object you touch with THE BLADE would just immediately become haunted.
		> L: I think specialized vessel makes most sense. Though maybe you can make most objects into SOUL vessels with the right spell? It would probably be very high level. Maybe [[Steve the Royalty-Free Skeleton]] is a haunted skeleton created by a magician with a weird sense of humour? #lun [lunR::1]
...
6. Inscribe the forbidden runes and speak aloud the unholy words \[ɪz θɪs lɔːs\]: ![[Power Word Kill.png]]
   > L: Sudo, are you creating a runic writing system out of thin air?! #lun [lunR::3]
...
> L: The ÜBERSOUL still needs to be partially in the vessel to maintain stability. Connection (as in transfer of mana) with the part in [[CURSED AL'S CURSED ORB|THE ORB]] could be taken care of by another artefact, if we need another one. Which fraction of the [[SOUL]] needs to remain in the vessel is an open question. #lun [lunR::4]

Sudosays:: I don't think this formula is right, but also: is it really that important?
> L: It is. Please fix it by the end of the week. #lun [lunR::5]
