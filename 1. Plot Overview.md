...
[Lun]: I guess you could have a cooldown after dashing multiple times, that can work gameplay-wise.

sudo:: Yeah, that makes sense. Plus, as a cross country runner, Luke is more geared towards long distance anyway, rather than short sprints. That's the extent of my knowledge about cross country, at least. Also, please don't delete the ref links from the Gameplay notes.
#reply [R:: 2]
