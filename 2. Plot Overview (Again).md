...
>[!question]+ Why does James want the Artifacts?
>Not "What does he tell Luke to convince him to get the Artifacts?" That's pretty easy. But what's *his* goal here? What is he going to do when he gets them?
>
>Obviously, he wants revenge on AL. How does acquiring the Artifacts help with that? Is he going to destroy them so that AL can't build the [[BFS 10000]]? Does he intend to build his own (or a different device that also requires the Artifacts)?
